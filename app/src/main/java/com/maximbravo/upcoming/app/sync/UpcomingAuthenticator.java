...
/**
 * Manages "Authentication" to Upcoming's backend service.  The SyncAdapter framework
 ...
 */
public class UpcomingAuthenticator extends AbstractAccountAuthenticator {

    public UpcomingAuthenticator(Context context) {
        super(context);
    }
