...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        c = db.rawQuery("PRAGMA table_info(" + EventContract.LocationEntry.TABLE_NAME + ")",
                null);
        ...
        locationColumnHashSet.add(EventContract.LocationEntry._ID);
        locationColumnHashSet.add(EventContract.LocationEntry.COLUMN_CITY_NAME);
        locationColumnHashSet.add(EventContract.LocationEntry.COLUMN_COORD_LAT);
        locationColumnHashSet.add(EventContract.LocationEntry.COLUMN_COORD_LONG);
        locationColumnHashSet.add(EventContract.LocationEntry.COLUMN_LOCATION_SETTING);
    ...
    */
    ...
    public long insertLocation() {
        ...
        Cursor cursor = db.query(
                EventContract.LocationEntry.TABLE_NAME,  // Table to Query
                null, // all columns
